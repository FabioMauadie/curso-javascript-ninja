(function(){
        ...
        */
        ...
        myFunction();
        VM1581:5 Na função `myFunction`, o primeiro número é 10
        VM1581:6 Na função `myFunction`, o segundo número é 20
        30
        ...
        */
        var sub = calculator(100,70);
        var multiplicacao = calculator(10,5);
        var divisao = calculator(500,10);
        var modulo = calculator(100,35);
        ...
        */
        ...
        console.log(multiplicacao(function(num1,num2){
        return num1 * num2;
        }) );


        console.log( 'O resultado da divisão é:' );
        console.log(divisao(function(num1,num2){
        return num1 / num2;
        }) );

        console.log( 'O resto da divisão é:' );
        console.log(modulo(function(num1,num2){
        return num1 % num2;
        }) );
})():
