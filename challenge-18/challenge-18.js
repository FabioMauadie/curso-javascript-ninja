  ...
  'use strict';
      ...
      */
      console.log( 'Limpando CPFs:' );
        ...
        function cleanCPF(Ncpf){
         return Ncpf.replace(/\D/g,  '');
       };
       //FAZENDO COM QUE MOSTRE TODOS OS CPFS NO CONSOLE
      ...
      cpfs.forEach(function(cpf){//VAI PERCORRER TODO O ARRAY CPF EXECUTANDO A FUNCAO CLEANCPF E MOSTRANDO NO CONSOLE
      ...
      */
      console.log( '\nFazer replace dos textos das tags:' );
       console.log(
        "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>".replace(/<(\w+)>([^<]+)<\/\w+>/g,  'O texto dentro da tag "$1" é "$2"</$1>\n'));
        <h1>O texto dentro da tag "h1" é "Título da página"</h1>
        <p>O texto dentro da tag "p" é "Este é um parágrafo"</p>
        <footer>O texto dentro da tag "footer" é "Rodapé"</footer>
